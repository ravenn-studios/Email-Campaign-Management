...
<div class="content-wrapper pb-0">
    <div class="page-header flex-wrap">
        <h3 class="mb-0"> Hi {{ Auth::user()->name }}, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Your campaign analytics dashboard template.</span>
        </h3>
        <div class="d-flex">
            <button type="button" class="btn btn-sm bg-white btn-icon-text border"><i class="mdi mdi-email btn-icon-prepend"></i> Email </button>
            <button type="button" class="btn btn-sm bg-white btn-icon-text border ml-3"><i class="mdi mdi-printer btn-icon-prepend"></i> Print </button>
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        <p class="mb-0 color-card-head">Active Campaign</p>
                                        <h3 class="text-white" style="width: 250px;">{!! $campaign->campaign_name !!}</h3>
                                    </div>
                                    <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-info"></i>
                                </div>
                                <h6 class="text-white">{!! \Carbon\Carbon::parse($campaign->start_date)->format('F d, Y') . ' - ' . \Carbon\Carbon::parse($campaign->end_date)->format('F d, Y') !!}</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                        <div class="card bg-danger">
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        <p class="mb-0 color-card-head">Total Recipients</p>
                                        <h2 class="text-white">{!! $campaign->get_total_recipients() !!}</h2>
                                    </div>
                                    <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
                                </div>
                                {{-- <h6 class="text-white">{!! $campaign->get_total_recipients_today() !!} Since This Morning</h6> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                        <div class="card bg-primary">
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        <p class="mb-0 color-card-head">Number of Unsubscribers</p>
                                        <h2 class="text-white">{!! $campaign->get_total_unsubscribers() !!}</h2>
                                    </div>
                                    <i class="card-icon-indicator mdi mdi-briefcase-outline bg-inverse-icon-primary"></i>
                                </div>
                                <h6 class="text-white">{!! $campaign->get_total_unsubscribers_today() !!} Today</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                        <div class="card bg-success">
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        <p class="mb-0 color-card-head">Spam Complaints</p>
                                        <h2 class="text-white">{!! $campaign->get_total_spam_complaints() !!}</h2>
                                    </div>
                                    <i class="card-icon-indicator mdi mdi-account-circle bg-inverse-icon-success"></i>
                                </div>
                                <h6 class="text-white">{!! $campaign->get_total_spam_complaints_today() !!} Today</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <p class="text-muted"> Show overview {!! \Carbon\Carbon::parse($campaign->start_date)->format('F d, Y') . ' - ' . \Carbon\Carbon::parse($campaign->end_date)->format('F d, Y') !!} <a class="text-muted font-weight-medium pl-2" href="#">
                                        <u>See Details</u>
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card mb-3 mb-sm-0">
                                    <div class="card-body py-3 px-4">
                                        <p class="m-0 survey-head">Total Opens</p>
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">{!! $campaign->get_total_opens() !!}</h3>
                            ...
                            <div class="col-sm-4">
                                <div class="card mb-3 mb-sm-0">
                                    <div class="card-body py-3 px-4">
                                        <p class="m-0 survey-head">Open Rate</p>
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">{!! $campaign->get_total_open_rate() !!}%</h3>
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="card-body py-3 px-4">
                                        <p class="m-0 survey-head">Click-Through Rate (CTR)</p>
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">{!! $campaign->get_total_clicks() !!}</h3>
                                                {{-- <p class="text-success m-0">-310 avg. sales</p> --}}
                                            </div>
        ...
        <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="text-black mt-3 d-block font-weight-medium h6" href="#">View all <i class="mdi mdi-chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 grid-margin stretch-card">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="text-black mt-3 mb-0 d-block h6" href="#">View all <i class="mdi mdi-chevron-right"></i>
                    </a>
                </div>
            </div>
            <!--activity ends-->
